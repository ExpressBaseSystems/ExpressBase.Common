...
namespace ExpressBase.Common.Helpers
{
    ...
    public static class MomentJSHelpers
    {
        ...
        public static string GenerateMomentJSFormatString(string fText, SerializedCulture fCulture)
        {
        ...
        private static string GenerateMomentJSFormatStringFromUserFormat(string fText, bool fTolerant, SerializedCulture fCulture)
        {
            ...
            foreach (var character in fText)
            {
                ...
                else
                {
                    switch (character)
                    {
                        ...
                        case ':':
                            ChangeState(State.None);
                            lResult.Append("[" + fCulture.DateTimeFormatInfo.TimeSeparator + "]");
                            break;
                        case '/':
                            ChangeState(State.None);
                            lResult.Append("[" + fCulture.DateTimeFormatInfo.DateSeparator + "]");
                            break;
                        case '\"':
        ...
        private static string GenerateMomentJSFormatStringFromStandardFormat(string fText, bool fTolerant, SerializedCulture fCulture)
        {
            string result;
            ...
            {
                case "d":
                    result = GenerateMomentJSFormatStringFromUserFormat(fCulture.DateTimeFormatInfo.ShortDatePattern, fTolerant, fCulture);
                    break;
                case "D":
                    result = GenerateMomentJSFormatStringFromUserFormat(fCulture.DateTimeFormatInfo.LongDatePattern, fTolerant, fCulture);
                    break;
                case "f":
                    result = GenerateMomentJSFormatStringFromUserFormat(fCulture.DateTimeFormatInfo.LongDatePattern + " " + fCulture.DateTimeFormatInfo.ShortTimePattern, fTolerant, fCulture);
                    break;
                case "F":
                    result = GenerateMomentJSFormatStringFromUserFormat(fCulture.DateTimeFormatInfo.FullDateTimePattern, fTolerant, fCulture);
                    break;
                case "g":
                    result = GenerateMomentJSFormatStringFromUserFormat(fCulture.DateTimeFormatInfo.ShortDatePattern + " " + fCulture.DateTimeFormatInfo.ShortTimePattern, fTolerant, fCulture);
                    break;
                case "G":
                    result = GenerateMomentJSFormatStringFromUserFormat(fCulture.DateTimeFormatInfo.ShortDatePattern + " " + fCulture.DateTimeFormatInfo.LongTimePattern, fTolerant, fCulture);
                    break;
                case "M":
                case "m":
                    result = GenerateMomentJSFormatStringFromUserFormat(fCulture.DateTimeFormatInfo.MonthDayPattern, fTolerant, fCulture);
                    break;
                case "O":
                case "o":
                ...
                case "s":
                    result = GenerateMomentJSFormatStringFromUserFormat(fCulture.DateTimeFormatInfo.UniversalSortableDateTimePattern, fTolerant, fCulture);
                    break;
                case "t":
                    result = GenerateMomentJSFormatStringFromUserFormat(fCulture.DateTimeFormatInfo.ShortTimePattern, fTolerant, fCulture);
                    break;
                case "T":
                    result = GenerateMomentJSFormatStringFromUserFormat(fCulture.DateTimeFormatInfo.LongTimePattern, fTolerant, fCulture);
                    break;
                case "u":
                ...
                case "Y":
                case "y":
                    result = GenerateMomentJSFormatStringFromUserFormat(fCulture.DateTimeFormatInfo.YearMonthPattern, fTolerant, fCulture);
                    break;
                default:
