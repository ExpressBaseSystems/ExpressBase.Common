...
namespace ExpressBase.Common.SqlProfiler
{
    public class Profiler
    {
        ...
        public int Cur_Mon_Max_id { get; set; }

        public decimal Cur_Mon_Max_exectime { get; set; }

        public int Cur_Mon_Min_id { get; set; }

        public decimal Cur_Mon_Min_exectime { get; set; }
