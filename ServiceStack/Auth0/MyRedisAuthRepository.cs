...
{
    public class MyRedisAuthRepository : RedisAuthRepository<UserAuth, UserAuthDetails>, IUserAuthRepository
    {
        public MyRedisAuthRepository(IRedisClientsManager f2) : base(f2) { }

        public MyRedisAuthRepository(IRedisClientManagerFacade factory) : base(factory) { }
    }
        ...
        where TUserAuthDetails : class, IUserAuthDetails
    {
        ...
        private readonly IRedisClientsManager factory2;

        public RedisAuthRepository(IRedisClientsManager f2)
            : this(new RedisClientManagerFacade(f2)) { this.factory2 = f2; }
        ...
        public IUserAuth UpdateUserAuth(IUserAuth existingUser, IUserAuth newUser)
        {
            ...
            using (var redis = factory2.GetClient())
            {
                //AssertNoExistingUser(redis, newUser, existingUser);

                //newUser.Id = existingUs/er.Id;
        ...
        public IUserAuth GetUserAuth(string userAuthId)
        {
            ...
            {
                return redis.Get<IUserAuth>(userAuthId);
            }
        }
