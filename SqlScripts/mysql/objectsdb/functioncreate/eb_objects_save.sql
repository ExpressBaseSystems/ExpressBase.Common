...
CALL eb_str_to_tbl_util(app_id,',');  -- fill to temp_array_table
...
UPDATE eb_objects e 
SET 
	e.obj_name = obj_name, e.obj_desc = obj_desc, e.obj_tags = tags , e.display_name = disp_name 
WHERE 
	e.id = objid;
