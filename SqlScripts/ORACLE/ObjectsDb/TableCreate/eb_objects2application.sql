...
BEGIN
	...
	EXECUTE IMMEDIATE 'CREATE OR REPLACE TRIGGER eb_objects2application_trigger BEFORE INSERT ON eb_objects2application FOR EACH ROW BEGIN ' || ':' || 'new.id:=eb_objects2application_id_seq.NEXTVAL; END;';
END;