...
namespace ExpressBase.Common
{
    ...
    public class PGSQLDatabase : IDatabase
    {
        ...
        public override string EB_AUTHENTICATEUSER_SOCIAL { get { return "SELECT * FROM eb_authenticate_unified(social := @social, wc := @wc);"; } }

        public override string EB_AUTHENTICATEUSER_SSO { get { return "SELECT * FROM eb_authenticate_unified(uname := @uname, wc := @wc);"; } }
