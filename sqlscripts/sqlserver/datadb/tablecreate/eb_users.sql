...
(
    ...
    dateformat varchar(max)  DEFAULT 'DD/MM/YYYY',
    timezone varchar(max)  DEFAULT 'UTC+05:30',
    numformat varchar(max)  DEFAULT '0,000.00',
    timezoneabbre varchar(max) ,
    timezonefull varchar(max) ,
