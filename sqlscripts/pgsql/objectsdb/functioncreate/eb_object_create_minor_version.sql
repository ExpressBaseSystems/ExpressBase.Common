...
minor integer;major integer; version_number text; relationsv text[];
...
ALTER FUNCTION public.eb_object_create_minor_version(text, integer, integer, text, text, text)
    OWNER TO postgres;
